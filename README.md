...
Please note that the script `run-pg-docker.sh` will rebuild the Docker images from scratch *every time you run it*. If you want to skip this extra effort, you can set the environment variable `FORCE_REBUILD` to a value before running the script, as for instance:
